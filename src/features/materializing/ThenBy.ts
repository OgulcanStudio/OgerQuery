...
export const thenByFeature: FeaturePlugin = {
  name: 'ThenBy',
  kind: 'orderBy',
  category: 'materializing',
  append(pipeline, keySelector: Selector<any, any>, options?: OrderByOptions) {
    return orderByFeature.append!(pipeline, keySelector, options ?? false);
  },
  executeSync: orderByFeature.executeSync!,
  testCases: [
    {
      name: 'subsequently sorts by thenBy key',
      source: [
        { a: 2, b: 10 },
        { a: 1, b: 20 },
        { a: 2, b: 5 },
